...

{
  ...
  country: { ro: "România", en: "Romania" },
  attendance: { value: null, approx: false, soldOut: false, note: null },
  referee: "Dan Buzărnescu",
  goals: [
    { team: "home", player: "Ianis Doană",       minute: 6 },
    { team: "home", player: "A. Chițu",          minute: 84 },
    { team: "home", player: "K. Appiah Nyarko",  minute: 90, added: 2 }
  ],
  cards: [
  ...
  statsSource: "Flashscore",
  note: {
    ro: "Poli Timișoara, nou-promovată din Liga 3 și neînvinsă până atunci în campionat, a câștigat cu 3-0 deși a jucat în inferioritate numerică din minutul 41, când căpitanul Andrei Artean (Știința Poli Timișoara) a fost eliminat. Ianis Doană (Știința Poli Timișoara) deschisese scorul în minutul 6, iar celelalte două goluri au venit pe final. Era a doua victorie a timișorenilor în fața mureșenilor în 11 zile, după 2-1 în calificările pentru grupele Cupei României. AFC ASA Târgu Mureș se afla în al doilea sezon în Liga 2, după ce a preluat locul celor de la Unirea Ungheni.",
    en: "Poli Timișoara, newly promoted from Liga 3 and unbeaten in the league until then, won 3-0 despite playing a man down from the 41st minute, when captain Andrei Artean (Știința Poli Timișoara) was sent off. Ianis Doană (Știința Poli Timișoara) had opened the scoring on 6 minutes and the other two goals came late. It was Timișoara's second win over Târgu Mureș in 11 days, after a 2-1 in the Romanian Cup qualifying rounds. AFC ASA Târgu Mureș were in their second Liga 2 season, having taken over the place of Unirea Ungheni."
  }
}
