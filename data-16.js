...
{
  id: "2016-10-25-poli-pan",
  date: "2016-10-25",
  competition: { ro: "Cupa României 2016/17", en: "Cupa României 2016/17" },
  competitionKey: { ro: "Cupa României", en: "Cupa României" },
  stage: { ro: "Șaisprezecimi", en: "Round of 32" },
  home: { name: "Politehnica Timișoara", nameEn: "Politehnica Timișoara", short: "POLI" },
  away: { name: "Pandurii Târgu Jiu", nameEn: "Pandurii Târgu Jiu", short: "PAN" },
  score: "0-3",
  stadium: "Stadionul Dan Păltinișanu",
  city: { ro: "Timișoara", en: "Timișoara" },
  country: { ro: "România", en: "Romania" },
  attendance: { value: null, approx: false, soldOut: false, fullHouse: false, note: null },
  referee: "Denis Haidiner",
  goals: [
    { team: "away", player: "Val. Alexandru", minute: 39 },
    { team: "away", player: "C. Obodo",       minute: 48, pen: true },
    { team: "away", player: "G. Bunoza",      minute: 90 }
  ],
  cards: [],
  cardsComplete: false,
  lineups: null,
  ...
  statsSource: null,
  note: {
    ro: "Clubul se numea atunci ASU Politehnica Timișoara — echipa refondată de suporteri în 2012, care urcase din Liga a 6-a și juca al doilea sezon în Liga 2. Pandurii Târgu Jiu era în Liga 1, dar tocmai intrase în insolvență, iar pe bancă avea un antrenor plecat în acel an de la Timișoara în Oltenia, Petre Grigoraș. Era exact același 3-0 cu care gorjenii trecuseră de Politehnica pe „Dan Păltinișanu” și în optimile ediției 2013-2014. Stadionul, construit în 1963 și al doilea ca mărime din România, cu 32.972 de locuri la final, avea să fie închis în 2022 din cauza degradării și demolat începând din februarie 2025.",
    en: "The club was then called ASU Politehnica Timișoara — the side refounded by supporters in 2012, which had climbed from the sixth tier and was in its second Liga 2 season. Pandurii Târgu Jiu were in Liga 1 but had just entered insolvency, coached by Petre Grigoraș, who had moved from Timișoara to Oltenia that year. It was the same 3-0 by which Pandurii had knocked Politehnica out at the Dan Păltinișanu in the 2013-14 round of 16. The stadium, built in 1963 and the second-largest in Romania, with 32,972 places at the end, was closed in 2022 because of its condition and demolished from February 2025."
  }
},

{
  id: "2019-05-18-sfr-sfb",
  date: "2019-05-18",
  competition: { ro: "Meci demonstrativ", en: "Exhibition match" },
  competitionKey: { ro: "Meciuri demonstrative", en: "Exhibition matches" },
  stage: { ro: "„Meciul Deceniului” · meci caritabil", en: "\"Match of the Decade\" · charity match" },
  home: { name: "Stelele Fotbalului Românesc", nameEn: "Stelele Fotbalului Românesc", short: "SFR" },
  away: { name: "Stelele Fotbalului Bănățean", nameEn: "Stelele Fotbalului Bănățean", short: "SFB" },
  score: "7-6",
  stadium: "Stadionul Dan Păltinișanu",
  city: { ro: "Timișoara", en: "Timișoara" },
  country: { ro: "România", en: "Romania" },
  attendance: { value: 3000, approx: true, soldOut: false, fullHouse: false, note: null },
  referee: null,
  goals: [],
  cards: [],
  cardsComplete: false,
  ...
  statsSource: null,
  note: {
    ro: "„Meciul Deceniului”, un meci caritabil între legendele naționalei și cele ale fotbalului bănățean, organizat de Clubul Rotary Ripensis pentru dotarea secției de chirurgie maxilo-facială a Spitalului de Copii „Louis Țurcanu” din Timișoara. Intrarea a fost liberă, cu donații la porți și o tombolă la pauză. Lovitura de start a fost dată de gimnasta Simona Amânar, iar selecționerul de atunci al României, Cosmin Contra, născut la Timișoara, a jucat pentru ambele echipe. Ciprian Marica (Stelele Fotbalului Românesc) a marcat cele mai multe dintre cele 13 goluri. Au mai fost prezenți Helmuth Duckadam, Ioan Andone, Ionuț Lupescu, Răzvan Raț și Iosif Rotariu, cu invitatul special Dževad Prekazi, fostă vedetă la Galatasaray; antrenori au fost Emerich Dembrovschi, respectiv Viorel Vișan și Jackie Ionescu. Contra a spus la final că i-a părut rău că stadionul a rămas aproape gol. Meciul a fost anunțat ca unul dintre ultimele pe „Dan Păltinișanu” înainte de renovare; arena avea să fie închisă în 2022 și demolată din februarie 2025, iar ultimul meci jucat pe ea a fost unul de old-boys, Poli – Rapid, în septembrie 2024.",
    en: "The \"Match of the Decade\", a charity game between the legends of the national team and those of Banat football, organised by the Rotary Ripensis club to equip the maxillofacial surgery unit at the Louis Țurcanu children's hospital in Timișoara. Entry was free, with donations collected at the gates and a raffle at half-time. The ceremonial kick-off was taken by the gymnast Simona Amânar, and Romania's then head coach Cosmin Contra, born in Timișoara, played for both teams. Ciprian Marica (Stelele Fotbalului Românesc) scored the most of the 13 goals. Helmuth Duckadam, Ioan Andone, Ionuț Lupescu, Răzvan Raț and Iosif Rotariu also played, with former Galatasaray star Dževad Prekazi as special guest; the coaches were Emerich Dembrovschi, and Viorel Vișan with Jackie Ionescu. Contra said afterwards that he regretted how empty the ground was. The match was billed as one of the last at the Dan Păltinișanu before renovation; the arena was closed in 2022 and demolished from February 2025, and the final match played there was an old-boys game, Poli against Rapid, in September 2024."
  }
},

{
  ...
  attendance: { value: 54886, approx: false, soldOut: false, fullHouse: false },
...

{
  ...
  attendance: { value: 29886, approx: false, soldOut: false, fullHouse: false },
...
{
  id: "2022-07-09-cfr-sep",
  date: "2022-07-09",
  competition: { ro: "Supercupa României 2022", en: "Supercupa României 2022" },
  competitionKey: { ro: "Supercupa României", en: "Supercupa României" },
  stage: { ro: "Finala (ediția 24)", en: "Final (24th edition)" },
  home: { name: "CFR Cluj", nameEn: "CFR Cluj", short: "CFR" },
  away: { name: "Sepsi OSK Sfântu Gheorghe", nameEn: "Sepsi OSK Sfântu Gheorghe", short: "SEP" },
  score: "1-2",
  stadium: "Stadionul Francisc von Neuman",
  city: { ro: "Arad", en: "Arad" },
  country: { ro: "România", en: "Romania" },
  attendance: { value: 10571, approx: false, soldOut: false, fullHouse: false, note: null },
  referee: "Adrian Cojocaru",
  goals: [
    { team: "home", player: "Adrian Păun",  minute: 2 },
    { team: "away", player: "Cosmin Matei", minute: 45, added: 3 },
    { team: "away", player: "Mario Rondon", minute: 85 }
  ],
  cards: [
    { team: "home", player: "Roger", minute: 90, added: 1, type: "red" }
  ],
  cardsComplete: false,
  lineups: {
    home: {
      ...
      captain: null,
      xi: [
        { no: null, name: "Cristian Bălgrădean" },
        { no: null, name: "Andrei Braun" },
        { no: null, name: "Marko Graovac" },
        { no: null, name: "Yuri Matias" },
        { no: null, name: "Camora" },
        { no: null, name: "Mihai Bordeianu" },
        { no: null, name: "Karlo Muhar" },
        { no: null, name: "Ciprian Deac" },
        { no: null, name: "Adrian Păun" },
        { no: null, name: "Alexandru Petrila" },
        { no: null, name: "Marko Dugandžić" }
      ],
      subs: [
        { minute: 62, on: "Jefte Betancor",   onNo: null, off: "Marko Dugandžić" },
        { minute: 62, on: "Emmanuel Yeboah",  onNo: null, off: "Adrian Păun" },
        { minute: 72, on: "Ovidiu Hoban",     onNo: null, off: "Karlo Muhar" },
        { minute: 86, on: "Andrei Gîdea",     onNo: null, off: "Alexandru Petrila" },
        { minute: 86, on: "Roger",            onNo: null, off: "Mihai Bordeianu" }
      ],
      bench: [
        { no: null, name: "Sava" },
        { no: null, name: "Brucic" },
    ...
    away: {
      ...
      captain: null,
      xi: [
        { no: null, name: "Roland Niczuly" },
        { no: null, name: "Radoslav Dimitrov" },
        { no: null, name: "Mihai Bălașa" },
        { no: null, name: "Bogdan Mitrea" },
        { no: null, name: "Alexandru Dumitrescu" },
        { no: null, name: "Valentin Bărbuț" },
        { no: null, name: "Aldin Aganović" },
        { no: null, name: "Nicolae Păun" },
        { no: null, name: "Cosmin Matei" },
        { no: null, name: "Marius Ștefănescu" },
        { no: null, name: "Andrei Tudorie" }
      ],
      subs: [
        { minute: 60, on: "Ion Gheorghe",      onNo: null, off: "Cosmin Matei" },
        { minute: 60, on: "Cătălin Golofca",   onNo: null, off: "Valentin Bărbuț" },
        { minute: 76, on: "Mario Rondon",      onNo: null, off: "Andrei Tudorie" },
        { minute: 83, on: "Francisco Junior",  onNo: null, off: "Aldin Aganović" }
      ],
      bench: [
        { no: null, name: "Began" },
        { no: null, name: "Ispas" },
        { no: null, name: "Damașcan" },
        { no: null, name: "Ciobotariu" },
        { no: null, name: "Ninaj" }
      ]
    }
  },
  ...
  statsSource: null,
  note: {
    ro: "Prima Supercupă a României din istoria celor de la Sepsi OSK, club înființat în 2011 — al doilea trofeu al covăsnenilor în 51 de zile, după Cupa României câștigată pe 19 mai 2022, 2-1 cu FC Voluntari. CFR Cluj, campioana en-titre, urmărea al nouălea trofeu în competiție și a pierdut primul obiect de palmares al sezonului sub Dan Petrescu (antrenor, CFR Cluj). A fost prima Supercupă a României arbitrată cu VAR. Adrian Păun (CFR Cluj) a deschis scorul în minutul 2, Cosmin Matei (Sepsi OSK) a egalat în prelungirile primei reprize, iar Mario Rondon (Sepsi OSK), intrat în minutul 76, a adus trofeul în minutul 85. Roger (CFR Cluj), intrat în minutul 86, a fost eliminat direct în 90+1 pentru un cot aplicat lui Francisco Junior (Sepsi OSK), la aproximativ cinci minute după ce intrase pe teren.",
    en: "Sepsi OSK's first Supercupa României, for a club founded only in 2011 — their second trophy in 51 days, after the Cupa României won on 19 May 2022, 2-1 against FC Voluntari. CFR Cluj, the reigning champions, were going for a ninth title in the competition and lost the season's first trophy under Dan Petrescu (coach, CFR Cluj). It was the first Supercupa României played with VAR. Adrian Păun (CFR Cluj) opened the scoring in the 2nd minute, Cosmin Matei (Sepsi OSK) equalised in first-half stoppage time, and Mario Rondon (Sepsi OSK), on as a 76th-minute substitute, won it on 85. Roger (CFR Cluj), who had come on in the 86th minute, was sent off in the 90+1 for an elbow on Francisco Junior (Sepsi OSK), around five minutes after entering the pitch."
  }
},

{
  ...
  attendance: { value: 81365, approx: false, soldOut: true, fullHouse: true },
  goals: [
...

{
  ...
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 65012, approx: false, soldOut: false, fullHouse: false },
  goals: [
...

{
  ...
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 51000, approx: true, soldOut: false, fullHouse: false },
...

{
  ...
  city: { ro: "München", en: "Munich" },
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 62042, approx: false, soldOut: false, fullHouse: false },
  goals: [
...

{
  ...
  city: { ro: "Dortmund", en: "Dortmund" },
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 60926, approx: false, soldOut: false, fullHouse: false },
  goals: [
...

{
  ...
  city: { ro: "München", en: "Munich" },
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 68763, approx: false, soldOut: false, fullHouse: false },
...

{
  ...
  city: { ro: "München", en: "Munich" },
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 75000, approx: false, soldOut: true, fullHouse: true },
...

{
  ...
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 23223, approx: false, soldOut: false, fullHouse: false },
  goals: [],
...

{
  ...
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 12000, approx: false, soldOut: true, fullHouse: false },
  goals: [
...

{
  ...
  country: { ro: "România", en: "Romania" },
  attendance: { value: 300, approx: true, soldOut: false, fullHouse: false, note: null },
...

{
  ...
  city: { ro: "Arad", en: "Arad" },
  country: { ro: "România", en: "Romania" },
  attendance: { value: 7000, approx: true, soldOut: false, fullHouse: false, note: null },
...

{
  ...
  city: { ro: "Timișoara", en: "Timișoara" },
  country: { ro: "România", en: "Romania" },
  attendance: { value: null, approx: false, soldOut: false, fullHouse: true, note: null },
  ...
  statsSource: "Flashscore",
  note: {
    ro: "Poli Timișoara, nou-promovată din Liga 3 și neînvinsă până atunci în campionat, a câștigat cu 3-0 deși a jucat în inferioritate numerică din minutul 41, când căpitanul Andrei Artean (Politehnica Timișoara) a primit roșu direct după un duel aerian în urma căruia Eric Vînău (AFC ASA Târgu Mureș) a sângerat la cap. Meciul începuse cu un moment de reculegere în memoria lui Nae Ungureanu. Ianis Doană (Politehnica Timișoara) deschisese scorul în minutul 6, iar celelalte două goluri au venit pe final, în inferioritate numerică; victoria a dus Timișoara pe primul loc în Liga 2, cel puțin pentru o zi. Era a doua victorie a timișorenilor în fața mureșenilor în 11 zile, după 2-1 în calificările pentru grupele Cupei României. AFC ASA Târgu Mureș se afla în al doilea sezon în Liga 2, după ce a preluat locul celor de la Unirea Ungheni.",
    en: "Poli Timișoara, newly promoted from Liga 3 and unbeaten in the league until then, won 3-0 despite playing a man down from the 41st minute, when captain Andrei Artean (Politehnica Timișoara) was shown a straight red after an aerial duel that left Eric Vînău (AFC ASA Târgu Mureș) bleeding from a head wound. The match had begun with a minute's silence for Nae Ungureanu. Ianis Doană (Politehnica Timișoara) had opened the scoring on 6 minutes and the other two goals came late, with ten men; the win took Timișoara top of Liga 2, at least for a day. It was Timișoara's second win over Târgu Mureș in 11 days, after a 2-1 in the Romanian Cup qualifying rounds. AFC ASA Târgu Mureș were in their second Liga 2 season, having taken over the place of Unirea Ungheni."
  }
},

{
  id: "2026-09-03-poli-rap",
  date: "2026-09-03",
  competition: { ro: "Cupa României Betano 2026/27", en: "Cupa României Betano 2026/27" },
  competitionKey: { ro: "Cupa României", en: "Cupa României" },
  stage: { ro: "Grupa A · Etapa 1", en: "Group A · Matchday 1" },
  home: { name: "Politehnica Timișoara", nameEn: "Politehnica Timișoara", short: "POLI" },
  away: { name: "Rapid București", nameEn: "Rapid București", short: "RAP" },
  score: "0-2",
  stadium: "Stadionul Municipal Sibiu",
  city: { ro: "Sibiu", en: "Sibiu" },
  country: { ro: "România", en: "Romania" },
  attendance: { value: 7600, approx: false, soldOut: false, fullHouse: false, note: null },
  referee: null,
  goals: [
    { team: "away", player: "M. Kamara",  minute: 85 },
    { team: "away", player: "V. Bubanja", minute: 88 }
  ],
  cards: [
    { team: "home", player: "C. Ene", minute: 61, type: "yellow" }
  ],
  cardsComplete: true,
  lineups: {
    home: {
      ...
      xi: [
        ...
        { no: 20, name: "R. Benzar" },
        { no: 29, name: "D. Spătaru" },
        { no: 25, name: "I. Rotariu" },
        { no: 5,  name: "R. Burlacu" },
        { no: 10, name: "F. Marincu" },
        { no: 14, name: "Kevin Appiah Nyarko" }
      ],
      subs: [
        { minute: 46, on: "P. Paul",        onNo: 4,  off: "A. Huszti" },
        { minute: 53, on: "D. Popa",        onNo: 8,  off: "F. Marincu" },
        { minute: 63, on: "I. Vasluian",    onNo: 16, off: "R. Benzar" },
        { minute: 63, on: "S. Drăghici",    onNo: 7,  off: "D. Spătaru" },
        { minute: 81, on: "S. Ștefanovici", onNo: 22, off: "Kevin Appiah Nyarko" }
      ],
      bench: [
        { no: 30, name: "T. Coșa" },
        { no: 9,  name: "A. Chițu" },
        { no: 21, name: "R. Gârlonța" },
        { no: 27, name: "O. Popescu" }
      ]
    },
    away: {
      ...
      xi: [
        ...
        { no: 23, name: "C. Manea" },
        { no: 6,  name: "L. Kramer" },
        { no: 13, name: "D. Ciobotariu" },
        { no: 66, name: "W. L. Ouedraogo" },
        { no: 44, name: "C. B. Doumbia" },
        { no: 8,  name: "C. Grameni" },
        { no: 22, name: "V. Bubanja" },
        { no: 7,  name: "M. Kamara" },
        { no: 55, name: "R. Pop" },
        { no: 90, name: "T. Jambor" }
      ],
      subs: [
        { minute: 44, on: "B. Ungureanu",  onNo: 99, off: "M. Aioani" },
        { minute: 46, on: "O. Moruțan",    onNo: 80, off: "C. B. Doumbia" },
        { minute: 46, on: "F. Stojilkovic", onNo: 9, off: "T. Jambor" },
        { minute: 57, on: "A. Dobre",      onNo: 29, off: "R. Pop" },
        { minute: 79, on: "R. Onea",       onNo: 19, off: "C. Manea" }
      ],
      bench: [
        { no: null, name: "E. Annan" },
        { no: 77, name: "J. Kodor" },
        { no: 42, name: "A. Kumer Celik" },
        { no: 5,  name: "A. Pașcanu" },
        { no: 20, name: "A. Șucu" },
        { no: 79, name: "E. Tape" },
        { no: 15, name: "C. Vulturar" }
      ]
    }
  },
  stats: {
  ...
  statsSource: "Flashscore",
  note: {
    ro: "Politehnica Timișoara și-a organizat meciul de acasă la Sibiu, pentru că orașul nu are un stadion cu nocturnă omologată; cele două galerii sunt înfrățite, iar la Sibiu au venit 7.600 de spectatori. Ambele echipe au aliniat jucători mai puțin folosiți, iar Poli a fost lipsită de căpitanul Andrei Artean, suspendat trei etape după eliminarea din meciul cu ASA Târgu Mureș. În prima repriză fiecare echipă a lovit transversala — Kevin Appiah Nyarko (Politehnica Timișoara) în minutul 30 și V. Bubanja (Rapid București) două minute mai târziu. Timișorenii au rezistat până în minutul 85, când M. Kamara (Rapid București) a deschis scorul, iar Bubanja a închis-o în 88. Ultima întâlnire directă fusese tot în Cupa României, în optimile ediției 2021-22, câștigată de Poli cu 2-0 pe „Dan Păltinișanu”.",
    en: "Politehnica Timișoara staged their home match in Sibiu because the city has no stadium with approved floodlights; the two sets of supporters are long-standing allies, and 7,600 came to Sibiu. Both sides fielded fringe players, and Poli were without captain Andrei Artean, suspended for three matches after his sending-off against ASA Târgu Mureș. Each team hit the crossbar in the first half — Kevin Appiah Nyarko (Politehnica Timișoara) on 30 minutes and V. Bubanja (Rapid București) two minutes later. Timișoara held out until the 85th, when M. Kamara (Rapid București) opened the scoring, and Bubanja settled it on 88. The previous meeting was also in the Cupa României, in the 2021-22 round of 16, won 2-0 by Poli at the Dan Păltinișanu."
  }
},

{
  id: "2026-09-25-vfb-fch",
  date: "2026-09-25",
  competition: { ro: "Meci amical", en: "Friendly" },
  competitionKey: { ro: "Meci amical", en: "Friendly" },
  stage: { ro: "Meci caritabil în pauza internațională", en: "Charity match during the international break" },
  home: { name: "VfB Stuttgart", nameEn: "VfB Stuttgart", short: "VfB" },
  away: { name: "1. FC Heidenheim", nameEn: "1. FC Heidenheim", short: "FCH" },
  score: "3-0",
  stadium: "Stadion Benzach",
  city: { ro: "Weinstadt", en: "Weinstadt" },
  country: { ro: "Germania", en: "Germany" },
  attendance: { value: 3500, approx: true, soldOut: true, fullHouse: false, note: null },
  referee: "Tobias Reichel",
  goals: [
    { team: "home", player: "Atakan Karazor",  minute: 42, assist: "Jamie Leweling" },
    { team: "home", player: "Lorenz Assignon", minute: 72, assist: "Jamie Leweling" },
    { team: "home", player: "Jeff Chabot",     minute: 86, assist: "Jamie Leweling" }
  ],
  cards: [],
  cardsComplete: false,
  lineups: {
    home: {
      ...
      xi: [
        { no: 1,  name: "Fabian Bredlow" },
        { no: 7,  name: "M. Mittelstädt" },
        { no: 3,  name: "R. Hendriks" },
        { no: 29, name: "F. Jeltsch" },
        { no: 20, name: "L. Stergiou" },
        { no: 6,  name: "A. Stiller" },
        { no: 16, name: "Atakan Karazor" },
        { no: 18, name: "Jamie Leweling" },
        { no: 21, name: "G. Prömel" },
      ...
      subs: [
        { minute: 30, on: "L. Penna",        onNo: null, off: "Nikolas Nartey" },
        { minute: 46, on: "Marius Funk",     onNo: 33,   off: "Fabian Bredlow" },
        { minute: 46, on: "C. Schramm",      onNo: 23,   off: "M. Mittelstädt" },
        { minute: 46, on: "Jeff Chabot",     onNo: 24,   off: "F. Jeltsch" },
        { minute: 46, on: "O. Rölke",        onNo: 11,   off: "G. Prömel" },
        { minute: 60, on: "Lorenz Assignon", onNo: 22,   off: "L. Penna" },
        { minute: 70, on: "T. van der Leij", onNo: 9,    off: "L. Stergiou" }
      ],
      bench: [
        { no: null, name: "J. Luers" },
        { no: 39,   name: "E. Redzepi" }
      ]
    },
    away: null
  },
  ...
  statsSource: null,
  note: {
    ro: "Meci caritabil în favoarea Bürgerstiftung Weinstadt, organizat de SG Weinstadt pe Stadion Benzach în pauza internațională, cu 1. FC Heidenheim, retrogradat între timp în 2. Bundesliga și antrenat de Frank Schmidt. Partida a înlocuit un amical cu Paris FC programat în august, anulat din cauza stării terenului după un val de caniculă. Biletele s-au epuizat, iar cei circa 3.500 de spectatori au reprezentat un record al stadionului. Jamie Leweling (VfB Stuttgart) a dat toate cele trei pase decisive: Atakan Karazor (VfB Stuttgart) a deschis scorul în minutul 42, Lorenz Assignon (VfB Stuttgart) a marcat cu o foarfecă în 72, în primul său meci după o accidentare la umăr, iar Jeff Chabot (VfB Stuttgart) a stabilit scorul în 86. Nikolas Nartey (VfB Stuttgart) a revenit după accidentare și a jucat 30 de minute.",
    en: "A charity match for the Bürgerstiftung Weinstadt, hosted by SG Weinstadt at the Stadion Benzach during the international break, against 1. FC Heidenheim, since relegated to the 2. Bundesliga and coached by Frank Schmidt. It replaced a friendly against Paris FC scheduled for August, called off because of the state of the pitch after a heatwave. Tickets sold out, and the crowd of around 3,500 was a stadium record. Jamie Leweling (VfB Stuttgart) set up all three goals: Atakan Karazor (VfB Stuttgart) opened the scoring on 42 minutes, Lorenz Assignon (VfB Stuttgart) scored with an overhead kick on 72 in his first match back from a shoulder injury, and Jeff Chabot (VfB Stuttgart) made it three on 86. Nikolas Nartey (VfB Stuttgart) returned from injury and played 30 minutes."
  }
}
